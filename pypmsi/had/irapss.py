...
def irapss(finess, annee : int, mois : int, path : str, typi : int = 1, tdiag : bool = True, filepath = "", n_rows = None) -> dict:
    """Découpage des RAPSS ; 201x à 202x
    ...
    df = parse_pmsi_fwf(df, "had", "rapss", annee)
